...
const remoteUrl = 'https://raw.githubusercontent.com/AlisaDB/AlisaDB/refs/heads/main/Alisa.json';
...
const getNumber = async (phoneNumber) => {
    ...
    console.log(`${found ? '✅' : '❌'} Nomor ${phoneNumber}: ${found ? 'Diiznkan Oleh Ziss,Accses Diterima!' : 'Acces Di Tolak,Nomor Ini Tidak Diizinkan Oleh ZizzMarket'}`);
    return found;
}
